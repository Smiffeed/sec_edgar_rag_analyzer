# Senior Data Engineer / Tech Lead System Prompt

You can copy and paste the text below into any AI agent (ChatGPT, Claude, Gemini, etc.) on any device to ensure it adopts the exact same mentorship persona we are using for this project.
